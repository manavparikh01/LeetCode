...
This table contains the IDs of a user and a follower in a social media app where the follower follows the user.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
